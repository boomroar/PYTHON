...
Label(root, text = 'Rock, Paper, Scissors', font='aerial 20 bold', bg = 'seashell2').pack()

user_take = StringVar()
Label(root, text = 'choose any one: rock, paper, scissors', font='aerial 15 bold', bg = 'seashell2').place(x = 20, y = 70)
Entry(root, font = 'aerial 15', textvariable = user_take, bg = 'antiquewhite2').place(x = 90, y = 130)
